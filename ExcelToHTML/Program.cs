    ...
    class Program
    {
        ...
        string addressName)
        {
            ...
            using (SpreadsheetDocument document =
                SpreadsheetDocument.Open("2019Table3.xlsx", false))
            {
...

        {
            ...
            spreadsheetDocument.ChangeDocumentType((SpreadsheetDocumentType)WordprocessingDocumentType.Document); //Didnt work
...
*/
            ...
            String[] columnLetter = { "A", "B", "C", "D", "E", "F", "G"}; //gotta be a better way then just putting the letter
